...
//                     if (obj.items == "") {
//                         $('<p class="no-result">Vous êtes arrivé à la fin de la liste !</p>').appendTo($(target));
                ...
                $.get(url, data, (result) => {
                    ...
                    if (obj.items == "") {
                        ...
                        switch (getCookie('wp-wpml_current_language')) {
                            case 'en':
                                label = 'Didn’t find what you wanted ? Try a new search';
                                break;
                            case 'fr':
                                label = 'Vous êtes arrivé à la fin de la liste !';
                                break;
                        }
